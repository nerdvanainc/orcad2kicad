...
STRINGS = {
    'ko': {
        ...
        'kind_net_diff': '넷 차이',
        # ---- 검증 탭 ----
        'verify_title_edif': '[1] EDIF 조인 vs 기준 넷리스트',
        'verify_title_geometry': '[2] 지오메트리 vs 기준 넷리스트',
        'verify_title_kicad': '[3] kicad-cli 넷리스트 vs 기준 넷리스트',
        ...
        'label_netlist_file': 'PADS 넷리스트(.asc) 또는 IPC-D-356(.ipc/.356/.d356)',
        'label_board_file': 'PADS 레이아웃 ASCII 또는 KiCad PCB',
        'label_outdir': '출력 폴더',
        'label_project': '프로젝트 이름',
        'label_kicad_cli': 'kicad-cli 경로',
        'filetype_all': '모든 파일',
        'filetype_netlist': 'PADS/IPC-D-356 넷리스트',
    ...
    'en': {
        ...
        'verify_title_edif': '[1] EDIF join vs reference netlist',
        'verify_title_geometry': '[2] Geometry vs reference netlist',
        'verify_title_kicad': '[3] kicad-cli netlist vs reference netlist',
        ...
        'label_netlist_file': 'PADS netlist (.asc) or IPC-D-356 (.ipc/.356/.d356)',
        ...
        'filetype_netlist': 'PADS/IPC-D-356 netlist',
